...
var file_proto_hello_proto_rawDesc = []byte{
	...
	0x0c, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x24, 0x0a,
...
var file_proto_hello_proto_depIdxs = []int32{
	0, // 0: HelloService.SayHello:input_type -> NoParam
	3, // 1: HelloService.SayHelloServerStreaming:input_type -> NamesList
	1, // 2: HelloService.SayHelloClientStreaming:input_type -> HelloRequest
	1, // 3: HelloService.SayHelloBidirectionalStreaming:input_type -> HelloRequest
	2, // 4: HelloService.SayHello:output_type -> HelloResponse
	2, // 5: HelloService.SayHelloServerStreaming:output_type -> HelloResponse
	4, // 6: HelloService.SayHelloClientStreaming:output_type -> MessagesList
	2, // 7: HelloService.SayHelloBidirectionalStreaming:output_type -> HelloResponse
